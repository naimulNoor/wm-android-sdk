...
internal interface APIs {
    companion object {
        ...
        // Check Payment
        const val CHECK_PAYMENT_SANDBOX = "aHR0cHM6Ly9zYW5kYm94LndhbGxldG1peC5jb20vY2hlY2stcGF5bWVudA=="
        ...
        //Call_back_url
        const val CALL_BACK_URL = "https://epay.walletmix.com/check-payment" // Any Url can be used as call_back_url
    }
}